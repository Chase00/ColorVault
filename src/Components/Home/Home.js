        ...
        <Container className="home-container">
            <Row>
                <Col md="6">
                    ...
                    <p class="home-text">Providing a free and easy solution for keeping track of your digital color codes. Whether you're a graphic designer working on the next eye-catching ad or a web designer creating a new site layout, Color Vault is for you!</p>
